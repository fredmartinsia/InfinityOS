---
id: modelar-o-que-ja-funciona
title: Modele o que ja funciona, nao invente
layer: copy
domain: conteudo
confidence: 0.65
deterministic: false
triggers: [conteudo, ideia de post, roteiro, oferta, referencia, modelar]
source: claude-mem (Qwen discovery)
code_ref: null
---
...
## Como aplicar
- Busque referencias com volume comprovado.
- Modele estrutura e angulo do que ja performa.
